...
# como parametro. Ex. linux: "python servidorping 5000" para usar
# a porta 5000. 
#
...
while True:
    ...
    if (read == 'leitura'):
		...
		# Consulta ultima medicao registrada no banco de dados do microcontrolador        
        data = CapturaMedicao()

        # Formata a mensagem para salvar no arquivo de texto
        #leitura_data =  '{} - {}, {}, {}, {}, {}, {}'.format(timestamp, *data[0])
        # Formata os valores lidos do banco de dados 
        leitura_data =  '{}, {}, {}, {}, {}, {}'.format(*data[0])
        
        # Envia, como resposta ao client, a string com as leituras 
