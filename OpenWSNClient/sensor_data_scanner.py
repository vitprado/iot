...
class WorkerThread(threading.Thread):
    ...
    def __init__(self,ip):
        ...
        self.create_coap()
        self.filewr = open('logdata.txt', 'w')
        ...
        while self.running:
            ...
            try:
                ...
                for k in keys:
                    ...
                    #rff - write in the file
                    #if  self.data[0]['value'] > 0 and self.data[1]['value'] > 0 and self.data[2]['value'] > 0:     
                    #    self.filewr.write('- '+str(self.data[0]['value']) + '- ' + str(self.data[1]['value']) + '- ' + str(self.data[2]['value']) +'\n')
                    #self.filewr.write('TESTE TESTE TESTE \n')
                #teste rff    
                #if lum >= 90 and led == 0:
                #    print 'turn on'
                #    self.do_write(1,1)
...
class SensorScannerGUI(object):
    def __init__(self, master):
        ...
        self.ipv6_addr.set('bbbb::12:4b00:040e:fc87')#'bbbb::1415:92cc:0:1')
